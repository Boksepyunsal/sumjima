                            ...
                            <div className="space-y-2">
                                ...
                                <ul className="list-disc space-y-1 pl-5">
                                    <li>
                                        ...
                                        수사·조사 등이 진행 중인 경우에는 해당 수사·조사 종료
                                        시까지 보존합니다.
                                    </li>
                                    <li>
                                        법령에 따른 보존: 전자상거래 등에서의 소비자보호에 관한
                                        법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우
                                        회사는 관계법령에서 정한 일정한 기간 동안 회원정보를
                                        보관합니다.
                                    </li>
                                </ul>
                            </div>
