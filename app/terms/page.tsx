                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
                            ...
                            <div className="space-y-2">
                                ...
                                <p>
                                    ② 요청자와 제공자 간에 이루어지는 모든 거래(서비스 계약,
                                    대금 결제, 서비스 품질, 하자 보수 등)에 대한 책임은 거래
                            ...
                            <div className="space-y-2">
                                ...
                                <p>
                                    ① &quot;숨지마&quot;의 모든 서비스(요청서 등록, 제안서
                                    제출, 회원 간 연결 등)는 현재 무료로 제공됩니다.
                                </p>
                                <p>
                                    ② 회사는 향후 서비스의 일부 또는 전부에 대해 유료로 전환할
                                    수 있으며, 이 경우 변경 사항을 사전에 회원에게 공지합니다.
                                </p>
                            </div>
